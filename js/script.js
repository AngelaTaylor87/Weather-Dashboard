...
var lDTemp = document.getElementById('fifth-d-temp')
var lDWind = document.getElementById('fifth-d-wind')
var lDHum = document.getElementById('fifth-d-hum')
var lDUvi = document.getElementById('fifth-d-uv')
    ...
    fetch(url)
        ...
        .then(function (data) {
            ...
            .then(function(data) {
                ...
                lDTemp.textContent = "Temp: " + data.daily[4].temp.day + " °F";
                lDWind.textContent = "Wind: " + data.daily[4].wind_speed + " MPH";
                lDHum.textContent = "Humidity: " + data.daily[4].humidity + " %";
                lDUvi.textContent = "Uv Index: " + data.daily[4].uvi;
            })
